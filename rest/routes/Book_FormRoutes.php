...
Flight::route("GET /book_form", function(){
  ...
  Flight::json(Flight::book_form_services()->get_all());

});

Flight::route("GET /book_form_by_id", function(){
  Flight::json(Flight::book_form_services()->get_by_id(Flight::request()->query['id']));
...
Flight::route("GET /book_form/@id", function($id){
  ...
  Flight::json(Flight::book_form_services()->get_by_id($id));
